...
/*lenovo-sw liuyc7 modify add tx buf begin*/
//#define C_UART1_VFF_TX_SIZE (1024)  /*the size must be 8-byte alignment*/
#define C_UART1_VFF_TX_SIZE (16*1024)  /*the size must be 8-byte alignment*/
/*lenovo-sw liuyc7 modify add tx buf end*/
/*lenovo-sw zhangdy4 2015-08-04, modify uart rx buf */
#define C_UART1_VFF_RX_SIZE (16*1024)  /*the size must be 8-byte alignment*/
