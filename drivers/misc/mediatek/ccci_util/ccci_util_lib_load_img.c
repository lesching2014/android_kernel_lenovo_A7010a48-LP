...
/*Lenovo-sw quebs2 modified 20150510 begin, deprecate this mechanism for modem check in secure boot*/
#if 0
		return -CCCI_ERR_LOAD_IMG_SIGN_FAIL;
#else
                return bypass_sec_header_offset;
#endif
/*Lenovo-sw quebs2 modified 20150510 end, deprecate this mechanism for modem check in secure boot*/
	}
}
