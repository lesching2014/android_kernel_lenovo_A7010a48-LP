...
//lenovo-sw wuwl10 20150820 add for ms delay begin
static void lcm_ms_delay(UINT32 ms)
{
    mdelay(ms);
}
//lenovo-sw wuwl10 20150820 add for ms delay end
