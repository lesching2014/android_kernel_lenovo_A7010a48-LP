...
/*lenovo-sw caoyi1 add for debug als data 20150618 begin*/
	ALSPS_LOG("+als_data_report! %d, %d\n",value,status);
/*lenovo-sw caoyi1 add for debug als data 20150618 end*/

/*lenovo-sw caoyi1 modify for filter invalid als data 20150618 begin*/
	if(value != -1)
	{
...
/*lenovo-sw caoyi1 modify for filter invalid als data 20150618 end*/
	return 0;
}
