...
static unsigned char CTPM_FW[] = {//lixh10
	...
	#include "Lenovo_K5_PVT_0100000F_20150918_app.i"
};
//zax 20150728++
...
static unsigned char CTPM_FW_2[] = {
	#include "Lenovo_K5_EVT_02000003_20150924_app.i"
};
//zax 20150728--
...
int fts_ctpm_auto_upgrade(struct i2c_client *client)
{
	...
	if((0x54!=chip_id) ||(uc_tp_fm_ver <uc_host_fm_ver)) //  fw_id_control  uc_tp_fm_ver < uc_host_fm_ver
	{
		msleep(100);
