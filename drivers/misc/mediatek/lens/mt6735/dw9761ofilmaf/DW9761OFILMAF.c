...
#define LENS_I2C_BUSNUM 0 //lenovo.sw wangsx3 change for K5 

#define AF_DRVNAME "DW9761OFILMAF"
#define I2C_SLAVE_ADDRESS        0x18
#define I2C_REGISTER_ID            0x19     //0x18 wuyt3 change for new I2C ID
...
static int s4AF_ReadReg(unsigned short * a_pu2Result)
{
    //int  i4RetValue = 0;
    //char pBuff[2];
    //lenovo.sw wangsx3  revise dw9761ofilmsf driver and open SAC mode
...
static int AF_Open(struct inode * a_pstInode, struct file * a_pstFile)
{
	...
	char puSendCmd4[2] = {0x07,0x03};//lenovo.sw wuyt3 modify for lens update{0x07,0x05};//Tvib=13.6ms 
