...
/*lenovo-sw caoyi1 add ps_status for TP 20150902 begin*/
...
/*lenovo-sw caoyi1 add ps_status for TP 20150902 end*/
...
/*lenovo-sw caoyi1 add ps enable attr 20150901 end*/
static DRIVER_ATTR(ps_offset,					S_IROTH  | S_IWOTH, NULL,								epl_sensor_store_ps_offset						);
...
static DRIVER_ATTR(ir_boost,					S_IROTH  | S_IWOTH, NULL,   							epl_sensor_store_ir_boost						);
...
static DRIVER_ATTR(osc,						    S_IROTH  | S_IWOTH, NULL,								epl_sensor_store_osc							);
...
static DRIVER_ATTR(i2c_max_count,			    S_IROTH  | S_IWOTH, NULL,   					 		epl_sensor_store_i2c_max_count				);
...
static DRIVER_ATTR(trig_intr_type,					S_IROTH  | S_IWOTH, epl_sensor_show_sen,           epl_sensor_store_intr_type                    );
/*lenovo-sw caoyi1 add for Psensor calibration ATTR 20150421 begin*/
#if LENOVO_CALI
static DRIVER_ATTR(cali_param_1,                S_IROTH  | S_IWOTH, epl_sensor_show_ps_h_threshold,     epl_sensor_store_ps_h_threshold                  );
static DRIVER_ATTR(cali_param_2,                S_IROTH  | S_IWOTH, epl_sensor_show_ps_l_threshold,     epl_sensor_store_ps_l_threshold                  );
#endif
/*lenovo-sw caoyi1 add for Psensor calibration ATTR 20150421 end*/
/*lenovo-sw caoyi1 add for selftest function 20150715 begin*/
static DRIVER_ATTR(selftest,                S_IROTH  | S_IWOTH, epl_sensor_show_selftest,           NULL                  );
/*lenovo-sw caoyi1 add for selftest function 20150715 end*/
/*lenovo-sw caoyi1 add for ps status attr 20150901 begin*/
static DRIVER_ATTR(ps_status,                S_IROTH  | S_IWOTH, epl_sensor_show_ps_status,           NULL                  );
/*lenovo-sw caoyi1 add for ps status attr 20150901 end*/
