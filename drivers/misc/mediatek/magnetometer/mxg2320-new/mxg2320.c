...
/*lenovo-sw caoyi1 add for Msensor 20150812 begin*/
                mxg2320_operation_mode(MXG2320_MOD_SNG_MEASURE);
/*lenovo-sw caoyi1 add for Msensor 20150812 end*/
...
/*lenovo-sw caoyi1 modify Msensor accuracy 20150810 begin*/
        //*status = data->mdata.ori.status;
	*status = data->mdata.mag.status;////update here...
/*lenovo-sw caoyi1 modify Msensor accuracy 20150810 end*/
        read_unlock(&data->mdata.datalock);
...
static int mxg2320_init_device(struct mxg2320_i2c_data *data)
{
        ...
        data->hw = get_cust_mag_hw_mxg2320();
...
static int mxg2320_local_init(void)
{
        struct mag_hw *hw = get_cust_mag_hw_mxg2320();
...
{
        struct mag_hw *hw = get_cust_mag_hw_mxg2320();
        i2c_register_board_info(hw->i2c_num, &i2c_mxg2320, 1);
////aaaaaaaaaaaaaaaafff
#ifdef MXG2320_MTK_NEW_SENSOR_ARCH
        MSE_INF("MXG2320 init new mtk architecture.20150731..\n");
