...
//begin, microtrust modify 2015.7.30
#include <linux/time.h>
//end, microtrust modify 2015.7.30
...
int emmc_rpmb_req_handle(struct mmc_card *card, struct emmc_rpmb_req *rpmb_req)
{
    ...
    int ret;
 //begin, [neusoft] [libaojun] [add] [move rpmb config file into ./mt6753][2015.04.24]
    //emmc_rpmb_dump_frame(rpmb_req->data_frame);
 //end, [neusoft] [libaojun] [add] [move rpmb config file into ./mt6753][2015.04.24]
